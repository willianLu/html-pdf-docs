import { _ as Ma } from './index-f681bPnu.js'
import './index-D9CJmY94.js'
var qa =
  typeof globalThis < 'u'
    ? globalThis
    : typeof window < 'u'
...
function Z() {
  ...
  return (
    (lr =
      ...
      n(typeof qa == 'object' && qa) ||
      n(typeof lr == 'object' && lr) ||
      (function () {
        return this
      })() ||
    ...
    (!v || !f) &&
      ...
      c
        ...
        : d && d.now
          ...
          : y && !h
            ? ((_ = new y()), (V = _.port2), (_.port1.onmessage = w), (O = r(V.postMessage, V)))
            : n.addEventListener &&
                t(n.postMessage) &&
                !n.importScripts &&
                E &&
...
function pr() {
  ...
  return (ki = { CONSTRUCTOR: f, REJECTION_EVENT: v, SUBCLASSING: c }), ki
}
var ji = {},
  Js
function yr() {
...
function dh() {
  ...
  var n = le(),
    ...
    he = function (C, q) {
      ...
      try {
        W
          ? ($ || (q.rejection === Ae && Or(q), (q.rejection = De)),
            W === !0 ? (Oe = G) : (xe && xe.enter(), (Oe = W(G)), xe && (xe.exit(), (ur = !0))),
            Oe === C.promise
    ...
    Ue = function (C, q, G) {
      ...
      B
        ? (($ = I.createEvent('Event')),
          ...
          t.dispatchEvent($))
        : ($ = { promise: q, reason: G }),
        !V && (W = t['on' + C]) ? W($) : C === z && p('Unhandled promise rejection', G)
    },
    xr = function (C) {
      i(g, t, function () {
        var q = C.facade,
  ...
  return (
    (zi = function (f, g, d) {
      ...
      if (m) E = f.iterator
        ...
        if (i(O)) {
          for (_ = 0, V = a(f); V > _; _++) if (((P = R(f[_])), P && s(v, P))) return P
          return new c(!1)
        }
        E = o(f, O)
      }
    ...
    x &&
      (v = function (E) {
        var O = this,
          ...
          U,
          I
        if (P) return (P.lastIndex = O.lastIndex), (M = n(v, P, V)), (O.lastIndex = P.lastIndex), M
        var j = _.groups,
          N = m && O.sticky,
          L = n(t, O),
          B = O.source,
...
`)) &&
          ...
          for (R.groups = U = s(null), A = 0; A < j.length; A++) (I = j[A]), (U[I[0]] = R[I[1]])
        return R
      }),
    (ia = v),
    ia
...
function Nh() {
  ...
  var n = le(),
    e = Za()
  return n({ target: 'RegExp', proto: !0, forced: /./.exec !== e }, { exec: e }), Eo
}
var aa, Do
function Ja() {
  if (Do) return aa
      ...
      function (w, k, R) {
        ...
        return [
          ...
          function (U, I) {
            ...
            for (var H = [], Q; (Q = d(j, N)), !(Q === null || (S(H, Q), !z)); ) {
              var Fe = h(Q[0])
            ...
            for (var De = '', Ae = 0, de = 0; de < H.length; de++) {
              Q = H[de]
              for (
                var pe = h(Q[0]), ye = m(b(u(Q.index), N.length), 0), Ie = [], Ne, he = 1;
                he < Q.length;
                he++
              )
                S(Ie, _(Q[he]))
          ...
          function (V, P) {
            ...
            for (var N = 0, L = 0, B = []; L < w.length; ) {
              ...
              if (z === null || (X = p(u(I.lastIndex + (g ? L : 0)), w.length)) === N)
                ...
                for (var H = 1; H <= z.length - 1; H++) if ((y(B, z[H]), B.length === j)) return B
                L = N = X
              }
            }
            return y(B, m(w, N)), B
...
function Ia(n, e, r) {
  ...
  var o = Va([(e - a) / 2, (r - s) / 2], (-n.xRot / 180) * Ge),
    u = o[0],
    l = o[1],
  ...
  function a(o, u, l, h, c, v) {
    return (
      ...
      i(function (f, g, d, p) {
        ...
        f.type & T.HORIZ_LINE_TO && u !== 0 && ((f.type = T.LINE_TO), (f.y = f.relative ? 0 : d)),
          f.type & T.VERT_LINE_TO && l !== 0 && ((f.type = T.LINE_TO), (f.x = f.relative ? 0 : g)),
        ...
        if (f.xRot !== void 0 && (o !== 1 || u !== 0 || l !== 0 || h !== 1))
          if (O === 0)
            ...
            var _ = (f.xRot * Math.PI) / 180,
              ...
              L = Math.sin(N),
              B = Math.cos(N)
            ;(f.rX = Math.abs(O) / Math.sqrt(U * E(B) + I * L * B + j * E(L))),
              (f.rY = Math.abs(O) / Math.sqrt(U * E(L) - I * L * B + j * E(B))),
    ...
    (n.NORMALIZE_HVZ = function (o, u, l) {
      return (
        ...
        i(function (h, c, v, f, g) {
          ...
          return (
            u && h.type & T.HORIZ_LINE_TO && ((h.type = T.LINE_TO), (h.y = h.relative ? 0 : v)),
            l && h.type & T.VERT_LINE_TO && ((h.type = T.LINE_TO), (h.x = h.relative ? 0 : c)),
            o &&
              h.type & T.CLOSE_PATH &&
              ((h.type = T.LINE_TO),
    ...
    (n.SANITIZE = function (o) {
      ...
      return i(function (v, f, g, d, p) {
        var y = Math.abs,
          ...
          x = 0
        if (
          (v.type & T.SMOOTH_CURVE_TO && ((b = isNaN(u) ? 0 : f - u), (x = isNaN(l) ? 0 : g - l)),
          ...
          var O = v.x2 === void 0 ? 0 : v.relative ? v.x : v.x2 - f,
            _ = v.y2 === void 0 ? 0 : v.relative ? v.y : v.y2 - g
        ...
        return T.ARC === o.type
          ? (function (h, c, v) {
              ...
              for (
                ...
                var _ = Iu(h.phi1, h.phi2, O / b),
                  V = Iu(h.phi1, h.phi2, (O + 1) / b),
                  P = V - _,
        ...
        c = i(function (v, f, g) {
          ...
          if (d.type & T.ARC) {
            ...
            for (
              ...
              (N = U[A]) > w && N < k && p(Nu(d.cX, O, V, N))
            for (var I = 0, j = Au(P, -_, 0).map(R); I < j.length; I++) {
              var N
              ;(N = j[I]) > w && N < k && y(Nu(d.cY, _, P, N))
            }
          }
          return v
        })
...
`
              ...
              if ((o !== '-' && o !== '+') || !this.curNumberHasExp || this.curNumberHasExpDigits)
                if (o !== '.' || this.curNumberHasExp || this.curNumberHasDecimal || u) {
                  if (this.curNumber && this.curCommandType !== -1) {
                    ...
                    this.curArgs.push(h),
                      this.curArgs.length === df[this.curCommandType] &&
                        (T.HORIZ_LINE_TO === this.curCommandType
                          ? a({ type: T.HORIZ_LINE_TO, relative: this.curCommandRelative, x: h })
                          : T.VERT_LINE_TO === this.curCommandType
                            ? a({ type: T.VERT_LINE_TO, relative: this.curCommandRelative, y: h })
                      ...
                      if (l) (this.curNumber = o), (this.curNumberHasDecimal = !1)
                        ...
                        if (((this.canParseCommandOrComma = !1), o !== 'z' && o !== 'Z'))
                          if (o === 'h' || o === 'H')
                            ...
                            (this.curCommandType = T.MOVE_TO), (this.curCommandRelative = o === 'm')
                          else if (o === 'l' || o === 'L')
                            (this.curCommandType = T.LINE_TO), (this.curCommandRelative = o === 'l')
                          else if (o === 'c' || o === 'C')
                            (this.curCommandType = T.CURVE_TO),
                            ...
                            (this.curCommandType = T.QUAD_TO), (this.curCommandRelative = o === 'q')
                          else if (o === 't' || o === 'T')
                            (this.curCommandType = T.SMOOTH_QUAD_TO),
  ...
  df =
    (((Te = {})[T.MOVE_TO] = 2),
    (Te[T.LINE_TO] = 2),
    (Te[T.HORIZ_LINE_TO] = 1),
    (Te[T.VERT_LINE_TO] = 1),
    (Te[T.CLOSE_PATH] = 0),
    (Te[T.QUAD_TO] = 4),
    (Te[T.SMOOTH_QUAD_TO] = 2),
    (Te[T.CURVE_TO] = 6),
    (Te[T.SMOOTH_CURVE_TO] = 4),
    (Te[T.ARC] = 7),
    Te),
  Du = {},
  Na,
...
function Sf(n, e, r, t, i, a) {
  ...
  for (var p = null, y = null, m = 0, b = 0, x = bf[a], S = xf[a], E = 0; E < i; E++) {
    ...
    for (var ye = 0; ye < t; ye++) {
      ...
      ;(L -= U), (B -= I), (z -= j), (X -= N), (U -= p.r), (I -= p.g), (j -= p.b), (N -= p.a)
      var he = ye + a + 1
      ;(he = (m + (he < u ? he : u)) << 2),
        (w += p.r = s[he]),
        (k += p.g = s[he + 1]),
  ...
  for (var ve = 0; ve < t; ve++) {
    ...
    var fe = s[b],
      ...
      We = c * q
    f = v
    for (var ur = 0; ur < h; ur++) (f.r = fe), (f.g = be), (f.b = C), (f.a = q), (f = f.next)
    for (var Tr = t, Hr = 0, Wr = 0, Yr = 0, Xr = 0, Sr = 1; Sr <= a; Sr++) {
      b = (Tr + ve) << 2
      var Er = h - Sr
      ;(Ve += (f.r = fe = s[b]) * Er),
        (xe += (f.g = be = s[b + 1]) * Er),
...
var kc = Object.freeze({ __proto__: null, offscreen: Ef, node: Rf })
function sr(n) {
...
var Nf = /(\[[^\]]+\])/g,
  _f = /(#[^\s+>~.[:]+)/g,
  Mf = /(\.[^\s+>~.[:]+)/g,
  qf = /(::[^\s+>~.[:]+|:first-line|:first-letter|:before|:after)/gi,
  Df = /(:[\w-]+\([^)]*\))/gi,
  Vf = /(:[^\s+>~.[:]+)/g,
  Lf = /([^\s+>~.[:]+)/g
function Ye(n, e) {
...
class D {
  ...
  getColor(e) {
    ...
    return (
      this.isNormalizedColor || ((this.isNormalizedColor = !0), (r = If(r)), (this.value = r)), r
    )
  }
  getDpi() {
    return 96
...
class J {
  ...
  static parsePath(e) {
    for (var r = ge(e), t = r.length, i = [], a = 0; a < t; a += 2) i.push(new J(r[a], r[a + 1]))
    return i
  }
  angleTo(e) {
...
class Bf {
  ...
  mapXY(e, r) {
    for (var { window: t, ctx: i } = this.screen, a = new J(e, r), s = i.canvas; s; )
...
var Ml = typeof window < 'u' ? window : null,
  ql = typeof fetch < 'u' ? fetch.bind(void 0) : null
class Ur {
  constructor(e) {
    var { fetch: r = ql, window: t = Ml } =
  ...
  render(e, r, t, i, a, s, o) {
    ...
    if (
      ...
      var m = ge(e.getAttribute('viewBox').getString()),
        b = 0,
        x = 0
      if (typeof i == 'number') {
...
Ur.defaultWindow = Ml
Ur.defaultFetch = ql
var { defaultFetch: Ff } = Ur,
  Uf = typeof DOMParser < 'u' ? DOMParser : null
class _a {
  constructor() {
    var { fetch: e = Ff, DOMParser: r = Uf } =
...
Qe.transformTypes = { translate: Gf, rotate: $f, scale: zf, matrix: Dl, skewX: Hf, skewY: Wf }
class K {
  constructor(e, r) {
...
class Y extends tr {
  ...
  renderChildren(e) {
    ...
    e.fillStyle !== '' && (r.getString('inherit') !== 'inherit' ? e.fill(r.getString()) : e.fill()),
      e.strokeStyle !== '' &&
    ...
    if (a) {
      for (
        var { unitsPerEm: s } = a.fontFace,
          ...
          v = ge(t.getAttribute('dx').getString()),
          f = c.length,
          g = 0;
        g < f;
        g++
    ...
    if (i) {
      for (
        var a = this.getFontSize(),
          ...
          o = ge(t.getAttribute('dx').getString()),
          u = s.length,
          l = 0,
          h = 0;
        h < u;
...
class br extends tr {
  ...
  setContext(e) {
    ...
    var h = this.getAttribute('refX'),
      ...
      f = v.hasValue() ? ge(v.getString()) : null,
...
class ac extends Y {
  ...
  getPoints() {
    return [
      new J(this.getAttribute('x1').getPixels('x'), this.getAttribute('y1').getPixels('y')),
      new J(this.getAttribute('x2').getPixels('x'), this.getAttribute('y2').getPixels('y')),
    ]
  }
  path(e) {
...
class sc extends K {
  ...
  createPattern(e, r, t) {
    ...
    ;(s.attributes.viewBox = new D(
      ...
      (s.attributes.height = new D(this.document, 'height', ''.concat(a, 'px'))),
  ...
  render(e, r, t) {
    if (r) {
      ...
      ;(u.type = this.type),
        ...
        (u.attributes.refX = new D(this.document, 'refX', this.getAttribute('refX').getValue())),
        (u.attributes.refY = new D(this.document, 'refY', this.getAttribute('refY').getValue())),
...
class mc extends ze {
  ...
  renderChildren(e) {
    if (this.hasText) {
      ...
      a.isWorking() &&
        a.checkBoundingBox(this, new Pe(t, i - s.getPixels('y'), t + this.measureText(e), i))
...
class bc extends ze {
    ...
    if (!this.glyphInfo) {
      ...
      ;(o === 'middle' || o === 'center') && (b = -p / 2),
        ...
        t.forEach((x, S) => {
          ...
          ;(b = E),
            !(!O.p0 || !O.p1) &&
              this.glyphInfo.push({ text: t[S], p0: O.p0, p1: O.p1, rotation: _ })
        })
    }
  }
  parsePathData(e) {
  ...
  getPointOnCubicBezier(e, r, t, i, a, s, o, u, l) {
    var h = u * Fu(e) + s * Uu(e) + i * Gu(e) + r * $u(e),
      c = l * Fu(e) + o * Uu(e) + a * Gu(e) + t * $u(e)
    return { x: h, y: c }
  }
  getPointOnQuadraticBezier(e, r, t, i, a, s, o) {
    var u = s * zu(e) + i * Hu(e) + r * Wu(e),
      l = o * zu(e) + a * Hu(e) + t * Wu(e)
    return { x: u, y: l }
  }
  ...
  renderChildren(e) {
    ...
    if (t) {
      ...
      if (
        (t.type === 'symbol' &&
          ((i = new br(r, null)),
          (i.attributes.viewBox = new D(r, 'viewBox', t.getAttribute('viewBox').getString())),
          (i.attributes.preserveAspectRatio = new D(
            r,
            'preserveAspectRatio',
            t.getAttribute('preserveAspectRatio').getString(),
          )),
          (i.attributes.overflow = new D(r, 'overflow', t.getAttribute('overflow').getString())),
        ...
        a.hasValue() && (i.attributes.width = new D(r, 'width', a.getString())),
          s.hasValue() && (i.attributes.height = new D(r, 'height', s.getString()))
      }
      var o = i.parent
    ...
    for (
      ...
      for (var h = 0; h < i; h++) {
        var c = Cr(u.data, h, l, i, a, 0),
          ...
          d = ie(o, 0, c) + ie(o, 1, v) + ie(o, 2, f) + ie(o, 3, g) + ie(o, 4, 1),
          p = ie(o, 5, c) + ie(o, 6, v) + ie(o, 7, f) + ie(o, 8, g) + ie(o, 9, 1),
          y = ie(o, 10, c) + ie(o, 11, v) + ie(o, 12, f) + ie(o, 13, g) + ie(o, 14, 1),
          m = ie(o, 15, c) + ie(o, 16, v) + ie(o, 17, f) + ie(o, 18, g) + ie(o, 19, 1)
...
class Rc extends K {
  ...
  apply(e) {
    ...
    t && ((t.beginPath = Xu), (t.closePath = Xu)),
      Reflect.apply(i, e, []),
...
class $e {
  ...
  setViewBox(e) {
    this.screen.setViewBox(Mc({ document: this }, e))
  }
}
$e.createCanvas = qc
$e.createImage = Dc
...
class fr {
  ...
  render() {
    ...
    return je(function* () {
      ...
      r.start(Xe({ enableRedraw: !0, ignoreAnimation: !0, ignoreMouse: !0 }, t)),
        yield r.ready(),
        r.stop()
    })()
  }
