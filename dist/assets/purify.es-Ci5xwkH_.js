/*! @license DOMPurify 3.2.4 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.2.4/LICENSE */ const {
  entries: dt,
  setPrototypeOf: at,
  isFrozen: Wt,
  getPrototypeOf: Bt,
...
let { freeze: S, seal: y, create: Tt } = Object,
  { apply: Ce, construct: we } = typeof Reflect < 'u' && Reflect
S ||
  (S = function (o) {
    return o
  })
...
const Z = { element: 1, text: 3, progressingInstruction: 7, comment: 8, document: 9 },
  ln = function () {
...
function gt() {
  ...
  let g = pt()
  o.isSupported =
    typeof dt == 'function' && typeof Q == 'function' && ue && ue.createHTMLDocument !== void 0
  const {
    MUSTACHE_EXPR: me,
    ERB_EXPR: pe,
    TMPLIT_EXPR: de,
  ...
  const Ht = l.createElement('form'),
    ...
    ye = function () {
      ...
      if (!(H && H === e)) {
        if (
          ((!e || typeof e != 'object') && (e = {}),
          (e = w(e)),
          (X = Ut.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? Ft : e.PARSER_MEDIA_TYPE),
          (m = X === 'application/xhtml+xml' ? Ne : ce),
          (u = L(e, 'ALLOWED_TAGS') ? a({}, e.ALLOWED_TAGS, m) : ke),
          (p = L(e, 'ALLOWED_ATTR') ? a({}, e.ALLOWED_ATTR, m) : Ue),
          (Oe = L(e, 'ALLOWED_NAMESPACES') ? a({}, e.ALLOWED_NAMESPACES, Ne) : vt),
          (Se = L(e, 'ADD_URI_SAFE_ATTR') ? a(w(je), e.ADD_URI_SAFE_ATTR, m) : je),
          (Ye = L(e, 'ADD_DATA_URI_TAGS') ? a(w(Xe), e.ADD_DATA_URI_TAGS, m) : Xe),
          (U = L(e, 'FORBID_CONTENTS') ? a({}, e.FORBID_CONTENTS, m) : Be),
          (B = L(e, 'FORBID_TAGS') ? a({}, e.FORBID_TAGS, m) : {}),
          (Te = L(e, 'FORBID_ATTR') ? a({}, e.FORBID_ATTR, m) : {}),
          (k = L(e, 'USE_PROFILES') ? e.USE_PROFILES : !1),
          (Fe = e.ALLOW_ARIA_ATTR !== !1),
          (_e = e.ALLOW_DATA_ATTR !== !1),
          (He = e.ALLOW_UNKNOWN_PROTOCOLS || !1),
          (ze = e.ALLOW_SELF_CLOSE_IN_ATTR !== !1),
          ...
          k &&
            ((u = a({}, ct)),
            (p = []),
            k.html === !0 && (a(u, lt), a(p, ft)),
            k.svg === !0 && (a(u, De), a(p, Me), a(p, le)),
            k.svgFilters === !0 && (a(u, be), a(p, Me), a(p, le)),
            k.mathMl === !0 && (a(u, Ie), a(p, ut), a(p, le))),
          e.ADD_TAGS && (u === ke && (u = w(u)), a(u, e.ADD_TAGS, m)),
          e.ADD_ATTR && (p === Ue && (p = w(p)), a(p, e.ADD_ATTR, m)),
          e.ADD_URI_SAFE_ATTR && a(Se, e.ADD_URI_SAFE_ATTR, m),
          e.FORBID_CONTENTS && (U === Be && (U = w(U)), a(U, e.FORBID_CONTENTS, m)),
          Ae && (u['#text'] = !0),
          C && a(u, ['html', 'head', 'body']),
          u.table && (a(u, ['tbody']), delete B.tbody),
          ...
          E === void 0 && (E = cn(J, T)),
            E !== null && typeof W == 'string' && (W = E.createHTML(''))
        S && S(e), (H = e)
      }
    },
    $e = a({}, [...De, ...be, ...Zt]),
          ...
          : e.namespaceURI === ne
            ? t.namespaceURI === I
              ...
              : t.namespaceURI === oe
                ...
                : !!qe[n]
            : e.namespaceURI === I
              ? (t.namespaceURI === oe && !ae[c]) || (t.namespaceURI === ne && !ie[c])
                ? !1
                : !qe[n] && (kt[n] || !$e[n])
              : !!(X === 'application/xhtml+xml' && Oe[e.namespaceURI])
        : !1
    },
    N = function (e) {
    ...
    Ke = function (e) {
      ...
      return (
        ...
        F === I ? bt.call(t, C ? 'html' : 'body')[0] : C ? t.documentElement : _
      )
    },
    Ze = function (e) {
      return Nt.call(
  ...
  const Qe = function (e) {
      let t = null
      if ((M(g.beforeSanitizeElements, e, null), Le(e))) return N(e), !0
      const n = m(e.nodeName)
      if (
        (M(g.uponSanitizeElement, e, { tagName: n, allowedTags: u }),
        (e.hasChildNodes() &&
          !Je(e.firstElementChild) &&
          A(/<[/\w]/g, e.innerHTML) &&
          A(/<[/\w]/g, e.textContent)) ||
          e.nodeType === Z.progressingInstruction ||
          (Ee && e.nodeType === Z.comment && A(/<[/\w]/g, e.data)))
      )
        return N(e), !0
      if (!u[n] || B[n]) {
        if (
      ...
      return (e instanceof xe && !zt(e)) ||
        ...
        : (P &&
            ...
            e.textContent !== t && (V(o.removed, { element: e.cloneNode() }), (e.textContent = t))),
          M(g.afterSanitizeElements, e, null),
          !1)
    },
    et = function (e, t, n) {
      if (Ge && (t === 'id' || t === 'name') && (n in l || n in Ht)) return !1
      if (!(_e && !Te[t] && A(Mt, t))) {
        if (!(Fe && A(Ct, t))) {
          if (!p[t] || Te[t]) {
            if (
    ...
    nt = function (e) {
      ...
      for (; c--; ) {
        const _ = t[c],
          { name: d, namespaceURI: O, value: D } = _,
          j = m(d)
        let h = d === 'value' ? D : $t(D)
        if (
          ((n.attrName = j),
          ...
          M(g.uponSanitizeAttribute, e, n),
          (h = n.attrValue),
          We && (j === 'id' || j === 'name') && (re(d, e), (h = Pt + h)),
          Ee && A(/((--!?|])>)|<\/(style|title)/i, h))
        ) {
          re(d, e)
          continue
        }
        if (n.forceKeepAttr || (re(d, e), !n.keepAttr)) continue
        if (!ze && A(/\/>/i, h)) {
          re(d, e)
          continue
        }
    ...
    (o.sanitize = function (i) {
      ...
      if ((ge || ye(e), (o.removed = []), typeof i == 'string' && (Y = !1), Y)) {
        if (i.nodeName) {
          ...
          if (!u[D] || B[D]) throw q('root node is forbidden and cannot be sanitized in-place')
        }
      } else if (i instanceof fe)
        (t = Ke('<!---->')),
          (n = t.ownerDocument.importNode(i, !0)),
          (n.nodeType === Z.element && n.nodeName === 'BODY') || n.nodeName === 'HTML'
            ? (t = n)
            : t.appendChild(n)
      else {
        if (!v && !P && !C && i.indexOf('<') === -1) return E && te ? E.createHTML(i) : i
        if (((t = Ke(i)), !t)) return v ? null : te ? W : ''
      }
      t && he && N(t.firstChild)
      const d = Ze(Y ? i : t)
      for (; (c = d.nextNode()); ) Qe(c), nt(c), c.content instanceof b && Gt(c.content)
      if (Y) return i
      if (v) {
        if (ee) for (_ = Dt.call(t.ownerDocument); t.firstChild; ) _.appendChild(t.firstChild)
        else _ = t
      ...
      return (
        C &&
          ...
          A(Et, t.ownerDocument.doctype.name) &&
          (O =
            '<!DOCTYPE ' +
            t.ownerDocument.doctype.name +
            `>
